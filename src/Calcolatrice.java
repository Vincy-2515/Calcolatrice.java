...
public class Calcolatrice extends javax.swing.JFrame {
    ...
    private History History = new History("history.txt");
    ...
    private Results updateTextFieldsWithResultOnMainDisplay(TextFields TF, Results R) {
        String temp;
    ...
    private Results updateTextFieldsWithResultOnSecondaryDisplay(TextFields TF, Results R, String key_pressed_operator) {
        if (R.OP.middle_operator_position == TF.secondary_display_content.length() - 1) {
    ...
    private Results handleOperation(TextFields TF, int result_destination) {
        ...
        if (result_destination == 0) { //destinazione del risultato nel main display
            if (after_equal) {
                TF.secondary_display_content = TF.secondary_display_content.substring(OP.middle_operator_position + 1, TF.secondary_display_content.length()); //prendo solo la parte dopo l'operatore
                ...
                TF.secondary_display_content = TF.secondary_display_content.substring(0, OP.middle_operator_position); //rimuovo l'operatore dal contenuto della stringa
                secondary_display_value = Double.parseDouble(TF.secondary_display_content);
